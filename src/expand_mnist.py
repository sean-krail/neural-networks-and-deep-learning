...
if os.path.exists(os.path.join(os.path.dirname(sys.path[0]),'data','mnist_expanded.pkl.gz')):
    ...
    f = gzip.open(os.path.join(os.path.dirname(sys.path[0]),'data','mnist_expanded.pkl.gz'), 'w')
