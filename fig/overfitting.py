...
def make_plots(
    ...
    plot_training_accuracy(
        training_accuracy, num_epochs, training_accuracy_xmin, training_set_size
    )
    plot_overlay(
        test_accuracy,
        training_accuracy,
...
def plot_training_cost(training_cost, num_epochs, training_cost_xmin):
    ...
    ax.plot(
        np.arange(training_cost_xmin, num_epochs),
...
def plot_test_accuracy(test_accuracy, num_epochs, test_accuracy_xmin):
    ...
    ax = fig.add_subplot(111)
    ax.plot(
        np.arange(test_accuracy_xmin, num_epochs),
        [accuracy / 100.0 for accuracy in test_accuracy[test_accuracy_xmin:num_epochs]],
        color="#2A6EA6",
    )
...
def plot_test_cost(test_cost, num_epochs, test_cost_xmin):
    ...
    ax = fig.add_subplot(111)
    ax.plot(
        np.arange(test_cost_xmin, num_epochs),
...
def plot_training_accuracy(
    ...
    ax = fig.add_subplot(111)
    ax.plot(
        np.arange(training_accuracy_xmin, num_epochs),
        [
